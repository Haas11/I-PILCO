...
#include "c2_IPILCO_relativeRPY_ST.h"
...
static void initialize_c2_IPILCO_relativeRPY_ST
  (SFc2_IPILCO_relativeRPY_STInstanceStruct *chartInstance);
static void initialize_params_c2_IPILCO_relativeRPY_ST
  (SFc2_IPILCO_relativeRPY_STInstanceStruct *chartInstance);
static void enable_c2_IPILCO_relativeRPY_ST
  (SFc2_IPILCO_relativeRPY_STInstanceStruct *chartInstance);
static void disable_c2_IPILCO_relativeRPY_ST
  (SFc2_IPILCO_relativeRPY_STInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_IPILCO_relativeRPY_ST
  (SFc2_IPILCO_relativeRPY_STInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_IPILCO_relativeRPY_ST
  (SFc2_IPILCO_relativeRPY_STInstanceStruct *chartInstance);
static void set_sim_state_c2_IPILCO_relativeRPY_ST
  (SFc2_IPILCO_relativeRPY_STInstanceStruct *chartInstance, const mxArray *c2_st);
static void finalize_c2_IPILCO_relativeRPY_ST
  (SFc2_IPILCO_relativeRPY_STInstanceStruct *chartInstance);
static void sf_gateway_c2_IPILCO_relativeRPY_ST
  (SFc2_IPILCO_relativeRPY_STInstanceStruct *chartInstance);
static void mdl_start_c2_IPILCO_relativeRPY_ST
  (SFc2_IPILCO_relativeRPY_STInstanceStruct *chartInstance);
static void c2_chartstep_c2_IPILCO_relativeRPY_ST
  (SFc2_IPILCO_relativeRPY_STInstanceStruct *chartInstance);
static void initSimStructsc2_IPILCO_relativeRPY_ST
  (SFc2_IPILCO_relativeRPY_STInstanceStruct *chartInstance);
static void c2_my_rpy2r(SFc2_IPILCO_relativeRPY_STInstanceStruct *chartInstance,
  real_T c2_rpy_in[3], real_T c2_R[9]);
static void c2_numcols(SFc2_IPILCO_relativeRPY_STInstanceStruct *chartInstance);
static void c2_numrows(SFc2_IPILCO_relativeRPY_STInstanceStruct *chartInstance);
static void c2_rotx(SFc2_IPILCO_relativeRPY_STInstanceStruct *chartInstance,
                    real_T c2_t, real_T c2_R[9]);
static void c2_roty(SFc2_IPILCO_relativeRPY_STInstanceStruct *chartInstance,
                    real_T c2_t, real_T c2_R[9]);
static void c2_rotz(SFc2_IPILCO_relativeRPY_STInstanceStruct *chartInstance,
                    real_T c2_t, real_T c2_R[9]);
static void c2_wtrans(SFc2_IPILCO_relativeRPY_STInstanceStruct *chartInstance,
                      real_T c2_T[16], real_T c2_W[6], real_T c2_Wt[6]);
static void c2_transl(SFc2_IPILCO_relativeRPY_STInstanceStruct *chartInstance,
                      real_T c2_x[16], real_T c2_t1[3]);
static void c2_t2r(SFc2_IPILCO_relativeRPY_STInstanceStruct *chartInstance,
                   real_T c2_T[16], real_T c2_R[9]);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static boolean_T c2_emlrt_marshallIn(SFc2_IPILCO_relativeRPY_STInstanceStruct
  *chartInstance, const mxArray *c2_b_INSERTED, const char_T *c2_identifier);
static boolean_T c2_b_emlrt_marshallIn(SFc2_IPILCO_relativeRPY_STInstanceStruct *
  chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_c_emlrt_marshallIn(SFc2_IPILCO_relativeRPY_STInstanceStruct
  *chartInstance, const mxArray *c2_b_inHole, const char_T *c2_identifier);
static real_T c2_d_emlrt_marshallIn(SFc2_IPILCO_relativeRPY_STInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_e_emlrt_marshallIn(SFc2_IPILCO_relativeRPY_STInstanceStruct
  *chartInstance, const mxArray *c2_b_y, const char_T *c2_identifier, real_T
  c2_c_y[12]);
static void c2_f_emlrt_marshallIn(SFc2_IPILCO_relativeRPY_STInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_b_y[12]);
...
static const mxArray *c2_f_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_g_emlrt_marshallIn(SFc2_IPILCO_relativeRPY_STInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static void c2_h_emlrt_marshallIn(SFc2_IPILCO_relativeRPY_STInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_b_y[6]);
...
static const mxArray *c2_g_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_i_emlrt_marshallIn(SFc2_IPILCO_relativeRPY_STInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_b_y[16]);
static void c2_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static void c2_j_emlrt_marshallIn(SFc2_IPILCO_relativeRPY_STInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_b_y[3]);
...
static const mxArray *c2_h_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_k_emlrt_marshallIn(SFc2_IPILCO_relativeRPY_STInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_b_y[9]);
...
static const mxArray *c2_i_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_l_emlrt_marshallIn(SFc2_IPILCO_relativeRPY_STInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_b_y[3]);
...
static c2_s3TYGqYEZfhjEunCONSnN4C c2_m_emlrt_marshallIn
  (SFc2_IPILCO_relativeRPY_STInstanceStruct *chartInstance, const mxArray *c2_u,
   const emlrtMsgIdentifier *c2_parentId);
static boolean_T c2_n_emlrt_marshallIn(SFc2_IPILCO_relativeRPY_STInstanceStruct *
  chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
...
static void c2_eml_scalar_eg(SFc2_IPILCO_relativeRPY_STInstanceStruct
  *chartInstance);
static void c2_threshold(SFc2_IPILCO_relativeRPY_STInstanceStruct *chartInstance);
static void c2_cross(SFc2_IPILCO_relativeRPY_STInstanceStruct *chartInstance,
                     real_T c2_a[3], real_T c2_b[3], real_T c2_c[3]);
static void c2_b_eml_scalar_eg(SFc2_IPILCO_relativeRPY_STInstanceStruct
  *chartInstance);
static const mxArray *c2_n_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_o_emlrt_marshallIn(SFc2_IPILCO_relativeRPY_STInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_k_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_p_emlrt_marshallIn(SFc2_IPILCO_relativeRPY_STInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_IPILCO_relativeRPY_ST, const
  char_T *c2_identifier);
static uint8_T c2_q_emlrt_marshallIn(SFc2_IPILCO_relativeRPY_STInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_IPILCO_relativeRPY_STInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc2_IPILCO_relativeRPY_STInstanceStruct
  *chartInstance);
  ...
  (SFc2_IPILCO_relativeRPY_STInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_IPILCO_relativeRPY_ST = 0U;
}
  ...
  (SFc2_IPILCO_relativeRPY_STInstanceStruct *chartInstance)
{
  ...
  c2_c_hoistedGlobal = chartInstance->c2_is_active_c2_IPILCO_relativeRPY_ST;
  ...
  (SFc2_IPILCO_relativeRPY_STInstanceStruct *chartInstance, const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_IPILCO_relativeRPY_ST = c2_p_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 3)),
     "is_active_c2_IPILCO_relativeRPY_ST");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_IPILCO_relativeRPY_ST(chartInstance);
  ...
  (SFc2_IPILCO_relativeRPY_STInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_IPILCO_relativeRPY_ST(chartInstance);
        ...
        if (CV_EML_COND(0, 1, 6, CV_RELATIONAL_EVAL(4U, 0U, 8, c2_b_xe[0],
          ...
          if (CV_EML_COND(0, 1, 7, CV_RELATIONAL_EVAL(4U, 0U, 9, c2_b_xe[0],
            ...
            if (!CV_EML_COND(0, 1, 8, chartInstance->c2_INSERTED)) {
              ...
              c2_Fext[0] += 300.0 * (c2_b_xe[0] - (c2_b_x_hole[0] + 0.016));
            } else {
              guard3 = true;
            }
          } else {
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_b_y = NULL;
  SFc2_IPILCO_relativeRPY_STInstanceStruct *chartInstance;
  chartInstance = (SFc2_IPILCO_relativeRPY_STInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_IPILCO_relativeRPY_ST_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c2_identifier)
{
  ...
  c2_b_y = c2_q_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_IPILCO_relativeRPY_ST), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_IPILCO_relativeRPY_ST);
  return c2_b_y;
}
...
void sf_c2_IPILCO_relativeRPY_ST_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3108332053U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3161849098U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2275101476U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4055689943U);
}

mxArray* sf_c2_IPILCO_relativeRPY_ST_get_post_codegen_info(void);
mxArray *sf_c2_IPILCO_relativeRPY_ST_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("wKJoyhbV5AzT2rZOByue1C");
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c2_IPILCO_relativeRPY_ST_get_post_codegen_info();
...
mxArray *sf_c2_IPILCO_relativeRPY_ST_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_IPILCO_relativeRPY_ST_jit_fallback_info(void)
{
...
mxArray *sf_c2_IPILCO_relativeRPY_ST_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_IPILCO_relativeRPY_ST(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[4],M[0],T\"INSERTED\",S'l','i','p'{{M1x2[388 396],M[0],}}},{M[4],M[0],T\"inHole\",S'l','i','p'{{M1x2[381 387],M[0],}}},{M[8],M[0],T\"is_active_c2_IPILCO_relativeRPY_ST\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_IPILCO_relativeRPY_ST_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_IPILCO_relativeRPY_STInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,3700);
        _SFD_CV_INIT_EML_IF(0,1,0,398,416,-1,436);
        _SFD_CV_INIT_EML_IF(0,1,1,437,457,-1,483);
        _SFD_CV_INIT_EML_IF(0,1,2,1322,1338,-1,1510);
        _SFD_CV_INIT_EML_IF(0,1,3,1360,1397,-1,1506);
        _SFD_CV_INIT_EML_IF(0,1,4,1512,1528,1606,1627);
        _SFD_CV_INIT_EML_IF(0,1,5,1606,1627,-1,1627);
        _SFD_CV_INIT_EML_IF(0,1,6,1693,1714,2251,2275);
        _SFD_CV_INIT_EML_IF(0,1,7,1819,1832,-1,1913);
        _SFD_CV_INIT_EML_IF(0,1,8,2251,2275,-1,2275);
        _SFD_CV_INIT_EML_IF(0,1,9,2327,2354,-1,2606);
        _SFD_CV_INIT_EML_IF(0,1,10,2496,2509,-1,2598);
        _SFD_CV_INIT_EML_IF(0,1,11,2616,2682,-1,2791);
        _SFD_CV_INIT_EML_IF(0,1,12,2823,2841,3214,3236);
        _SFD_CV_INIT_EML_IF(0,1,13,3003,3016,-1,3105);
        _SFD_CV_INIT_EML_IF(0,1,14,3214,3236,-1,3236);
        _SFD_CV_INIT_EML_IF(0,1,15,3363,3376,-1,3465);

        {
          static int condStart[] = { 1363, 1382 };

          static int condEnd[] = { 1378, 1397 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,0,1363,1397,2,0,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 1696, 1708 };

          static int condEnd[] = { 1703, 1714 };

          static int pfixExpr[] = { 0, 1, -1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,1,1696,1714,2,2,&(condStart[0]),&(condEnd[0]),
                                4,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 2258, 2269 };

          static int condEnd[] = { 2265, 2275 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,2,2258,2275,2,4,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 2619, 2646, 2674 };

          static int condEnd[] = { 2642, 2669, 2682 };

          static int pfixExpr[] = { 0, 1, -3, 2, -1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,3,2619,2682,3,6,&(condStart[0]),&(condEnd[0]),
                                6,&(pfixExpr[0]));
        }

        _SFD_CV_INIT_EML_RELATIONAL(0,1,0,1325,1338,-1,4);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,1,1363,1378,-1,4);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,2,1382,1397,-1,2);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,3,1515,1528,-1,4);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,4,1613,1627,-1,2);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,5,1822,1832,-1,4);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,6,2330,2354,-1,4);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,7,2499,2509,-1,4);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,8,2619,2642,-1,4);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,9,2646,2669,-1,2);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,10,2826,2841,-1,4);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,11,3006,3016,-1,4);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,12,3221,3236,-1,2);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,13,3366,3376,-1,2);
...
{
  return "cYEnCSt4kD32wR6UHgkE1";
}

static void sf_opaque_initialize_c2_IPILCO_relativeRPY_ST(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_IPILCO_relativeRPY_STInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_IPILCO_relativeRPY_ST
    ((SFc2_IPILCO_relativeRPY_STInstanceStruct*) chartInstanceVar);
  initialize_c2_IPILCO_relativeRPY_ST((SFc2_IPILCO_relativeRPY_STInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_IPILCO_relativeRPY_ST(void *chartInstanceVar)
{
  enable_c2_IPILCO_relativeRPY_ST((SFc2_IPILCO_relativeRPY_STInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_IPILCO_relativeRPY_ST(void *chartInstanceVar)
{
  disable_c2_IPILCO_relativeRPY_ST((SFc2_IPILCO_relativeRPY_STInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_IPILCO_relativeRPY_ST(void *chartInstanceVar)
{
  sf_gateway_c2_IPILCO_relativeRPY_ST((SFc2_IPILCO_relativeRPY_STInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c2_IPILCO_relativeRPY_ST(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c2_IPILCO_relativeRPY_ST
    ((SFc2_IPILCO_relativeRPY_STInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c2_IPILCO_relativeRPY_ST(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c2_IPILCO_relativeRPY_ST
    ((SFc2_IPILCO_relativeRPY_STInstanceStruct*)chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c2_IPILCO_relativeRPY_ST(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_IPILCO_relativeRPY_STInstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_IPILCO_relativeRPY_ST((SFc2_IPILCO_relativeRPY_STInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc2_IPILCO_relativeRPY_ST
    ((SFc2_IPILCO_relativeRPY_STInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_IPILCO_relativeRPY_ST(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c2_IPILCO_relativeRPY_ST
      ((SFc2_IPILCO_relativeRPY_STInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_IPILCO_relativeRPY_ST(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(771438552U));
  ssSetChecksum1(S,(4143667339U));
  ssSetChecksum2(S,(1802951332U));
  ssSetChecksum3(S,(4255548936U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_IPILCO_relativeRPY_ST(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_IPILCO_relativeRPY_ST(SimStruct *S)
{
  SFc2_IPILCO_relativeRPY_STInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_IPILCO_relativeRPY_STInstanceStruct *)utMalloc(sizeof
    (SFc2_IPILCO_relativeRPY_STInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_IPILCO_relativeRPY_STInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_IPILCO_relativeRPY_ST;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_IPILCO_relativeRPY_ST;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_IPILCO_relativeRPY_ST;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_IPILCO_relativeRPY_ST;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_IPILCO_relativeRPY_ST;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_IPILCO_relativeRPY_ST;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_IPILCO_relativeRPY_ST;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_IPILCO_relativeRPY_ST;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_IPILCO_relativeRPY_ST;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_IPILCO_relativeRPY_ST;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_IPILCO_relativeRPY_ST;
...
void c2_IPILCO_relativeRPY_ST_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_IPILCO_relativeRPY_ST(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_IPILCO_relativeRPY_ST(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_IPILCO_relativeRPY_ST(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_IPILCO_relativeRPY_ST_method_dispatcher.\n"
