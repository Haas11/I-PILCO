...
#include "c2_IPILCO_SimpleImp_relativeRPY_S.h"
...
static void initialize_c2_IPILCO_SimpleImp_relativeRPY_S
  (SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct *chartInstance);
static void initialize_params_c2_IPILCO_SimpleImp_relativeRPY_S
  (SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct *chartInstance);
static void enable_c2_IPILCO_SimpleImp_relativeRPY_S
  (SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct *chartInstance);
static void disable_c2_IPILCO_SimpleImp_relativeRPY_S
  (SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_IPILCO_SimpleImp_relativeRPY_S
  (SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_IPILCO_SimpleImp_relativeRPY_S
  (SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct *chartInstance);
static void set_sim_state_c2_IPILCO_SimpleImp_relativeRPY_S
  (SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct *chartInstance, const
   mxArray *c2_st);
static void finalize_c2_IPILCO_SimpleImp_relativeRPY_S
  (SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct *chartInstance);
static void sf_gateway_c2_IPILCO_SimpleImp_relativeRPY_S
  (SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct *chartInstance);
static void mdl_start_c2_IPILCO_SimpleImp_relativeRPY_S
  (SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct *chartInstance);
static void c2_chartstep_c2_IPILCO_SimpleImp_relativeRPY_S
  (SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct *chartInstance);
static void initSimStructsc2_IPILCO_SimpleImp_relativeRPY_S
  (SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct *chartInstance);
static void c2_my_rpy2r(SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct
  *chartInstance, real_T c2_rpy_in[3], real_T c2_R[9]);
static void c2_numcols(SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct
  *chartInstance);
static void c2_numrows(SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct
  *chartInstance);
static void c2_rotx(SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct
                    *chartInstance, real_T c2_t, real_T c2_R[9]);
static void c2_roty(SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct
                    *chartInstance, real_T c2_t, real_T c2_R[9]);
static void c2_rotz(SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct
                    *chartInstance, real_T c2_t, real_T c2_R[9]);
static void c2_wtrans(SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct
                      *chartInstance, real_T c2_T[16], real_T c2_W[6], real_T
                      c2_Wt[6]);
static void c2_transl(SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct
                      *chartInstance, real_T c2_x[16], real_T c2_t1[3]);
static void c2_t2r(SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct
                   *chartInstance, real_T c2_T[16], real_T c2_R[9]);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static boolean_T c2_emlrt_marshallIn
  (SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct *chartInstance, const
   mxArray *c2_b_INSERTED, const char_T *c2_identifier);
...
static real_T c2_c_emlrt_marshallIn
  (SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct *chartInstance, const
   mxArray *c2_b_INHOLE, const char_T *c2_identifier);
...
static void c2_e_emlrt_marshallIn
  (SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct *chartInstance, const
   mxArray *c2_b_y, const char_T *c2_identifier, real_T c2_c_y[12]);
static void c2_f_emlrt_marshallIn
  (SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct *chartInstance, const
   mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_b_y[12]);
...
static void c2_h_emlrt_marshallIn
  (SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct *chartInstance, const
   mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_b_y[6]);
...
static void c2_i_emlrt_marshallIn
  (SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct *chartInstance, const
   mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_b_y[16]);
static void c2_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static void c2_j_emlrt_marshallIn
  (SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct *chartInstance, const
   mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_b_y[3]);
...
static void c2_k_emlrt_marshallIn
  (SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct *chartInstance, const
   mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_b_y[9]);
...
static c2_s3TYGqYEZfhjEunCONSnN4C c2_m_emlrt_marshallIn
  (SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct *chartInstance, const
   mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static boolean_T c2_n_emlrt_marshallIn
  (SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct *chartInstance, const
   mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
...
static void c2_eml_scalar_eg(SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct
  *chartInstance);
static void c2_threshold(SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct
  *chartInstance);
static void c2_cross(SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct
                     *chartInstance, real_T c2_a[3], real_T c2_b[3], real_T
                     c2_c[3]);
static void c2_b_eml_scalar_eg(SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct
  *chartInstance);
...
static uint8_T c2_p_emlrt_marshallIn
  (SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct *chartInstance, const
   mxArray *c2_b_is_active_c2_IPILCO_SimpleImp_relativeRPY_S, const char_T
   *c2_identifier);
  ...
  (SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_IPILCO_SimpleImp_relativeRPY_S = 0U;
}
  ...
  (SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_INHOLE;
  ...
  c2_b_hoistedGlobal = chartInstance->c2_INSERTED;
  ...
  c2_c_hoistedGlobal =
    chartInstance->c2_is_active_c2_IPILCO_SimpleImp_relativeRPY_S;
   ...
   mxArray *c2_st)
{
  ...
  chartInstance->c2_INHOLE = c2_c_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_u, 1)), "INHOLE");
  chartInstance->c2_INSERTED = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_u, 2)), "INSERTED");
  chartInstance->c2_is_active_c2_IPILCO_SimpleImp_relativeRPY_S =
    c2_p_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 3)),
    "is_active_c2_IPILCO_SimpleImp_relativeRPY_S");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_IPILCO_SimpleImp_relativeRPY_S(chartInstance);
  ...
  (SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_IPILCO_SimpleImp_relativeRPY_S(chartInstance);
  ...
  (SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct *chartInstance)
{
  ...
  if (CV_EML_IF(0, 1, 2, CV_RELATIONAL_EVAL(4U, 0U, 0, c2_b_xe[0], c2_b_xc[0],
    ...
    if (CV_EML_IF(0, 1, 4, CV_RELATIONAL_EVAL(4U, 0U, 3, c2_b_xe[0],
          c2_b_x_hole[0] + 0.033, -1, 4U, c2_b_xe[0] > c2_b_x_hole[0] + 0.033)))
    {
  ...
  if (CV_EML_IF(0, 1, 5, CV_RELATIONAL_EVAL(4U, 0U, 4, c2_b_xe[1], c2_b_xc[1],
    ...
    if (CV_EML_IF(0, 1, 6, CV_RELATIONAL_EVAL(4U, 0U, 5, c2_b_xe[1], -c2_b_xc[1],
  ...
  if (CV_EML_COND(0, 1, 2, c2_CONTACT != 0.0)) {
    if (!CV_EML_COND(0, 1, 3, chartInstance->c2_INHOLE != 0.0)) {
      ...
      if (CV_EML_IF(0, 1, 8, CV_RELATIONAL_EVAL(4U, 0U, 6, c2_b_dxe[0], 0.0, -1,
            4U, c2_b_dxe[0] > 0.0))) {
  ...
  if (guard1 == true) {
    ...
    if (CV_EML_COND(0, 1, 4, c2_CONTACT != 0.0)) {
      if (CV_EML_COND(0, 1, 5, chartInstance->c2_INHOLE != 0.0)) {
        ...
        if (CV_EML_IF(0, 1, 10, CV_RELATIONAL_EVAL(4U, 0U, 7, c2_b_xe[0],
              c2_b_x_hole[0] + 0.05, -1, 4U, c2_b_xe[0] > c2_b_x_hole[0] + 0.05)))
        {
          ...
          if (CV_EML_IF(0, 1, 11, CV_RELATIONAL_EVAL(4U, 0U, 8, c2_b_dxe[0], 0.0,
                -1, 4U, c2_b_dxe[0] > 0.0))) {
        ...
        guard3 = false;
        guard4 = false;
        if (CV_EML_COND(0, 1, 6, CV_RELATIONAL_EVAL(4U, 0U, 9, c2_b_xe[0],
              c2_b_x_hole[0] + 0.016, -1, 4U, c2_b_xe[0] > c2_b_x_hole[0] +
              0.016))) {
          if (CV_EML_COND(0, 1, 7, CV_RELATIONAL_EVAL(4U, 0U, 10, c2_b_xe[0],
        ...
        if (CV_EML_IF(0, 1, 13, CV_RELATIONAL_EVAL(4U, 0U, 11, c2_b_xe[1],
          ...
          if (CV_EML_IF(0, 1, 14, CV_RELATIONAL_EVAL(4U, 0U, 12, c2_b_dxe[1],
          ...
          if (CV_EML_IF(0, 1, 15, CV_RELATIONAL_EVAL(4U, 0U, 13, c2_b_xe[1],
            ...
            if (CV_EML_IF(0, 1, 16, CV_RELATIONAL_EVAL(4U, 0U, 14, c2_b_dxe[1],
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_b_y = NULL;
  SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct *chartInstance;
  chartInstance = (SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct *)
    chartInstanceVoid;
   ...
   *c2_identifier)
{
  ...
  c2_b_y = c2_q_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_IPILCO_SimpleImp_relativeRPY_S), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_IPILCO_SimpleImp_relativeRPY_S);
  return c2_b_y;
}
...
void sf_c2_IPILCO_SimpleImp_relativeRPY_S_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2793781619U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2982471302U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(622658863U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2372611345U);
}

mxArray* sf_c2_IPILCO_SimpleImp_relativeRPY_S_get_post_codegen_info(void);
mxArray *sf_c2_IPILCO_SimpleImp_relativeRPY_S_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("9yySMBBNVlzppbljVtWSa");
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c2_IPILCO_SimpleImp_relativeRPY_S_get_post_codegen_info();
...
mxArray *sf_c2_IPILCO_SimpleImp_relativeRPY_S_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_IPILCO_SimpleImp_relativeRPY_S_jit_fallback_info(void)
{
...
mxArray *sf_c2_IPILCO_SimpleImp_relativeRPY_S_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_IPILCO_SimpleImp_relativeRPY_S
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[4],M[0],T\"INHOLE\",S'l','i','p'{{M1x2[381 387],M[0],}}},{M[4],M[0],T\"INSERTED\",S'l','i','p'{{M1x2[388 396],M[0],}}},{M[8],M[0],T\"is_active_c2_IPILCO_SimpleImp_relativeRPY_S\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_IPILCO_SimpleImp_relativeRPY_S_get_check_sum(&mxChecksum);
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML(0,1,1,17,0,0,0,0,0,9,4);
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,3736);
        _SFD_CV_INIT_EML_IF(0,1,0,398,416,-1,436);
        _SFD_CV_INIT_EML_IF(0,1,1,437,457,-1,483);
        _SFD_CV_INIT_EML_IF(0,1,2,1320,1336,-1,1605);
        _SFD_CV_INIT_EML_IF(0,1,3,1358,1395,-1,1504);
        _SFD_CV_INIT_EML_IF(0,1,4,1509,1537,-1,1601);
        _SFD_CV_INIT_EML_IF(0,1,5,1607,1623,1701,1722);
        _SFD_CV_INIT_EML_IF(0,1,6,1701,1722,-1,1722);
        _SFD_CV_INIT_EML_IF(0,1,7,1788,1809,2362,2386);
        _SFD_CV_INIT_EML_IF(0,1,8,1918,1931,-1,2012);
        _SFD_CV_INIT_EML_IF(0,1,9,2362,2386,-1,2386);
        _SFD_CV_INIT_EML_IF(0,1,10,2434,2461,-1,2668);
        _SFD_CV_INIT_EML_IF(0,1,11,2558,2571,-1,2660);
        _SFD_CV_INIT_EML_IF(0,1,12,2678,2744,-1,2853);
        _SFD_CV_INIT_EML_IF(0,1,13,2885,2903,3252,3274);
        _SFD_CV_INIT_EML_IF(0,1,14,3041,3054,-1,3143);
        _SFD_CV_INIT_EML_IF(0,1,15,3252,3274,-1,3274);
        _SFD_CV_INIT_EML_IF(0,1,16,3399,3412,-1,3501);

        {
          static int condStart[] = { 1361, 1380 };

          static int condEnd[] = { 1376, 1395 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,0,1361,1395,2,0,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 1791, 1803 };

          static int condEnd[] = { 1798, 1809 };

          static int pfixExpr[] = { 0, 1, -1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,1,1791,1809,2,2,&(condStart[0]),&(condEnd[0]),
                                4,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 2369, 2380 };

          static int condEnd[] = { 2376, 2386 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,2,2369,2386,2,4,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 2681, 2708, 2736 };

          static int condEnd[] = { 2704, 2731, 2744 };

          static int pfixExpr[] = { 0, 1, -3, 2, -1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,3,2681,2744,3,6,&(condStart[0]),&(condEnd[0]),
                                6,&(pfixExpr[0]));
        }

        _SFD_CV_INIT_EML_RELATIONAL(0,1,0,1323,1336,-1,4);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,1,1361,1376,-1,4);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,2,1380,1395,-1,2);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,3,1512,1537,-1,4);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,4,1610,1623,-1,4);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,5,1708,1722,-1,2);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,6,1921,1931,-1,4);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,7,2437,2461,-1,4);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,8,2561,2571,-1,4);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,9,2681,2704,-1,4);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,10,2708,2731,-1,2);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,11,2888,2903,-1,4);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,12,3044,3054,-1,4);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,13,3259,3274,-1,2);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,14,3402,3412,-1,2);
...
{
  return "6qIGXIlIpl4hteysvLCkn";
}

static void sf_opaque_initialize_c2_IPILCO_SimpleImp_relativeRPY_S(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_IPILCO_SimpleImp_relativeRPY_S
    ((SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct*) chartInstanceVar);
  initialize_c2_IPILCO_SimpleImp_relativeRPY_S
    ((SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_IPILCO_SimpleImp_relativeRPY_S(void
  *chartInstanceVar)
{
  enable_c2_IPILCO_SimpleImp_relativeRPY_S
    ((SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_IPILCO_SimpleImp_relativeRPY_S(void
  *chartInstanceVar)
{
  disable_c2_IPILCO_SimpleImp_relativeRPY_S
    ((SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_IPILCO_SimpleImp_relativeRPY_S(void
  *chartInstanceVar)
{
  sf_gateway_c2_IPILCO_SimpleImp_relativeRPY_S
    ((SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c2_IPILCO_SimpleImp_relativeRPY_S
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c2_IPILCO_SimpleImp_relativeRPY_S
    ((SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c2_IPILCO_SimpleImp_relativeRPY_S(SimStruct*
  S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c2_IPILCO_SimpleImp_relativeRPY_S
    ((SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct*)
     chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c2_IPILCO_SimpleImp_relativeRPY_S(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_IPILCO_SimpleImp_relativeRPY_S
      ((SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_IPILCO_SimpleImp_relativeRPY_S
    ((SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_IPILCO_SimpleImp_relativeRPY_S(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_IPILCO_SimpleImp_relativeRPY_S(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(189058072U));
  ssSetChecksum1(S,(1811672772U));
  ssSetChecksum2(S,(1270536324U));
  ssSetChecksum3(S,(747601705U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_IPILCO_SimpleImp_relativeRPY_S(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_IPILCO_SimpleImp_relativeRPY_S(SimStruct *S)
{
  SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct *)utMalloc
    (sizeof(SFc2_IPILCO_SimpleImp_relativeRPY_SInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_IPILCO_SimpleImp_relativeRPY_S;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_IPILCO_SimpleImp_relativeRPY_S;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_IPILCO_SimpleImp_relativeRPY_S;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_IPILCO_SimpleImp_relativeRPY_S;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_IPILCO_SimpleImp_relativeRPY_S;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_IPILCO_SimpleImp_relativeRPY_S;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_IPILCO_SimpleImp_relativeRPY_S;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_IPILCO_SimpleImp_relativeRPY_S;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_IPILCO_SimpleImp_relativeRPY_S;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_IPILCO_SimpleImp_relativeRPY_S;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_IPILCO_SimpleImp_relativeRPY_S;
...
void c2_IPILCO_SimpleImp_relativeRPY_S_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_IPILCO_SimpleImp_relativeRPY_S(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_IPILCO_SimpleImp_relativeRPY_S(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_IPILCO_SimpleImp_relativeRPY_S(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_IPILCO_SimpleImp_relativeRPY_S_method_dispatcher.\n"
